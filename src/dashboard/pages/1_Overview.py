...
# def _safe(fn: Callable[..., T], *args: Any, **kwargs: Any) -> tuple[T | None, str | None]:
#     """
#     Calls a data_loader function and returns (result, error_message).
#     Isolates NotImplementedError (backend not wired yet) so one missing
#     piece of the backend doesn't take down the whole page — each section
...
# def _not_wired_notice(message: str) -> None:
#     st.markdown(
#         f"""
